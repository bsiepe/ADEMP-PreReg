...
\begin{examplebox}
We will upload the fully reproducible simulation script and a data set containing all relevant estimates, standard errors, and \textit{p}-values for each iteration of the simulation to OSF and GitHub (\url{https://github.com/bsiepe/SimPsychReview}).
\end{examplebox}
